...
contribution to one of Cloud Robotics's repositories. A change is e.g.
...
discussed or [implemented][Cloud Robotics Projects]. If your RFC conflicts with
...
Follow this process to get your feature merged into Cloud Robotics.
  ...
  - The person that actually merges the PR will create a new *project* for the
    ...
    [projects pane][Cloud Robotics Projects] of the Cloud Robotics repository and
    assign an RFC number.
  - When you create implementing PRs, please add a link to the RFC in the PR
    description.

[Cloud Robotics Projects]: https://github.com/googlecloudrobotics/core/projects
